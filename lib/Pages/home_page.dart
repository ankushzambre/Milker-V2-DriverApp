...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  //   try {
  //     per.PermissionStatus permissionStatus;
  //     permissionStatus = await per.Permission.location.status;
  //     if (permissionStatus.isDenied) {
  //       permissionStatus = await per.Permission.location.request();
  //     }
  ...
  //     }
  //   } catch (e) {
  //     print("Exceptioin - base.dart - _getLocationPermission():" + e.toString());
  //   }
  // }
